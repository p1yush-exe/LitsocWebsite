...
const subsocs = [
  { name: "PoetSoc",              href: "/poetsoc"    },
  { name: "Anubhooti",            href: "/anubhooti"  },
  { name: "DebSoc",               href: "/debsoc"     },
  { name: "Punjabi Soc",          href: "/punjabisoc" },
  { name: "Muse",                 href: "/muse"       },
  { name: "Thapar Quizzing Club", href: "/tqc"        },
  { name: "Cineastes",            href: "/cineastes"  },
  { name: "Theatre Soc",          href: "/theatre"    },
];
        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-8 gap-y-1.5 text-xs font-lato">
              {subsocs.map((s) => (
                <li key={s.name}>
                  <a href={s.href} className="hover:text-milk-yellow transition-colors">{s.name}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Instagram" className="hover:text-milk-yellow transition-colors">
              ...
              <a href="#" aria-label="YouTube" className="hover:text-milk-yellow transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="Twitter" className="hover:text-milk-yellow transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
